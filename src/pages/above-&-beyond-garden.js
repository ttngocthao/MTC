...
import CasePageLayout,{ IntroWrap,LeftCol,RightCol } from '../components/cases/CasePageLayout'
import HeroImg from '../images/cases/garden/fullHero.png'
import PageIntro from '../components/pageIntro/PageIntro'
import Scope from '../components/cases/Scope'
...
const BeyondGarden = () => {
    return (
        <CasePageLayout heroImg={HeroImg} caseName='Above &#38; Beyond Garden' caseNameArr={['Above &','Beyond Garden']} caseStudy={true} caseDescription='Designing your outdoor space to fit your aesthetic and lifestyle.'>
            <CaseIntro
